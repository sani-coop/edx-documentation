...
* Fixed poor discussion forum performance. (:jira:`TNL-5173`)
  
* Fixed a problem preventing adding a comment to response on inline
  discussions. (:jira:`TNL-5389`)

* Fixed links to vertical blocks. (:jira:`TNL-5003`)
